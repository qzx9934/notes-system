...
| `source` | string | 否 | 来源，默认 `个人总结`。**只能取以下 10 个值之一**（API 强校验，不接受自定义）：规程 / 规章制度 / 技术文件 / 技术通知 / 操作票 / 事故预案 / 事故通报与经验反馈 / 缺陷异常 / 培训 / 个人总结 |
...
- source：来源，从 规程/规章制度/技术文件/技术通知/操作票/事故预案/事故通报与经验反馈/缺陷异常/培训/个人总结 中选择（仅此 10 项，非法值上传时会被归一为「个人总结」）
